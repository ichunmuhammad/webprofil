                    ...
                    <div class="row el-element-overlay">
                        <div class="col-md-7">
                            <div class="form-group">
                                <label for="Path" class="mb-2">Foto Galeri</label>
                                <div class="card" style="margin-bottom:0px;">
                                    <div class="el-card-item" style="margin-bottom:0px;padding-bottom:0px;">
                                        <div class="el-card-avatar el-overlay-1" style="margin-bottom:0px;"> 
                                            ...
                                            $imgsrc = "#";
                                            ?>
                                            <img src="<?= $imgsrc; ?>" id="img-foto-galeri" alt="preview file galeri disini" style="max-height: 200px;object-fit:contain;border: solid #ddd 0.1em;background: #000;">
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?= base_url('galeri'); ?>" class="btn btn-secondary"><i class="fa fa-fw fa-times"></i> Batal</a>
                            </div>
                        </div>
                    </div>
                </form>
