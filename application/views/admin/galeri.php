        ...
        <nav aria-label="...">
            <ul class="pagination">
                <li class="page-item active">
                    <a class="page-link pl-4 pr-4" href="#" tabindex="-1">Foto<span class="sr-only">(current)</span></a>
                </li>
                <li class="page-item">
                    <a class="page-link pl-4 pr-4" href="<?= base_url('galeri/video'); ?>" tabindex="-1">Video</a>
                </li>
            </ul>
        </nav>
    </div>
    <div class="col-lg-12 mt-4">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="<?= base_url('galeri/'); ?>" method="get">
                            <div class="row">
                                <div class="col-sm-9">
                                ...
                                <div class="col-sm-3">
                                    <span class="float-right">
                                        <a href="<?= base_url('galeri/tambah/'); ?>" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i> Tambah</a>
                                    </span>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-lg-12">                    
                        <div class="row el-element-overlay">
                            ...
                            <?php endforeach; 
                                ...
                                <div class="col-lg-12 p-4"><b><i>Tidak ada data galeri</i></b></div>
                            <?php endif; ?>
                        </div>
                    </div>
...
$(document).ready(function(){
    $('.btn-del-pos').on('click', function(){
        ...
        $('#IdPos').val(idpos);
        $('#msg-hapus').html('Anda yakin ingin menghapus data galeri <br><b>"'+judul+'"</b> ini ?');
        $('#delModal').modal('show');
    })
    $('.btn-hide-pos').on('click', function(){
        ...
        $('#msg-publik').html('Anda yakin ingin menyembunyikan data galeri <br><b>"'+judul+'"</b> ini dari publikasi ?');
    ...
    $('.btn-show-pos').on('click', function(){
        ...
        $('#msg-publik').html('Anda yakin ingin menampilkan data galeri <br><b>"'+judul+'"</b> ini ke publikasi ?');
        $('#publikModal').modal('show');
    })
})
</script>