                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <span class="float-right">
                                        <a href="<?= base_url('pengumuman/tambah'); ?>" class="btn btn-primary"><i class="fa fa-fw fa-plus"></i> Tambah</a>
                                    </span>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table table-striped">
                                ...
                                <?php if($datapos):
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="<?= base_url('pengumuman/edit?id='.$pos->IdPos); ?>" class="btn btn-success ml-2 mb-2"><i class="fa fa-fw fa-edit"></i></a>
...
$(document).ready(function(){
    $('.btn-del-pos').on('click', function(){
        ...
        $('#IdPos').val(idpos);
        $('#msg-hapus').html('Anda yakin ingin menghapus data pengumuman <br><b>"'+judul+'"</b> ini ?');
        $('#delModal').modal('show');
    })
})
</script>